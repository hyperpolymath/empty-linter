...
Replace all {{PLACEHOLDER}} values with your information:
  Empty Linter     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  empty-linter             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/empty-linter/security/advisories/new)
...
- This repository (`hyperpolymath/empty-linter`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/empty-linter/security/advisories)
...
When using Empty Linter, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/empty-linter/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/empty-linter/security/advisories/new) or 6759885+hyperpolymath@users.noreply.github.com |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/empty-linter/discussions) |
...
*Thank you for helping keep Empty Linter and its users safe.* 🛡️
