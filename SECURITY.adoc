...
[arabic]
. Navigate to
https://github.com/hyperpolymath/empty-linter/security/advisories/new[Report
a Vulnerability]
...
https://github.com/hyperpolymath/empty-linter/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/empty-linter/discussions[GitHub
Discussions]
...
_Thank you for helping keep Empty Linter and its users safe._ 🛡️
