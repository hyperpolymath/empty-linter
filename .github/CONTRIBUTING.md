...
git clone <https://github.com/hyperpolymath/empty-linter.git> cd
empty-linter
...
toolbox create empty-linter-dev toolbox enter empty-linter-dev \#
...
empty-linter/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/empty-linter/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/empty-linter/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/empty-linter/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/empty-linter/labels/perimeter-3) — Community sandbox scope
